...
<h1 class="text-2xl font-bold font-sans">Doctors</h1>
<!-- Start of Cards -->
...
<div class="w-full mt-6">
    <div class="flex justify-end">
        <a href="/doctors/create" class="flex items-center justify-center bg-primary hover:bg-secondary text-white font-bold py-2 px-4 rounded w-40">      
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    @foreach($doctors as $doctor)
        <div class="bg-white dark:bg-dark shadow-md rounded-lg overflow-hidden">
            <img class="w-full h-48 object-cover object-center" src="{{$doctor->image}}" alt="{{ $doctor->name }}">
            <div class="p-4">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white">{{ $doctor->name }}</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">{{ $doctor->speciality }}</p>
                <div class="flex items-center mt-2">
                    ...
                    <span class="ml-2 text-sm text-gray-600 dark:text-gray-300">{{ $doctor->phone }}</span>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="/doctors/{{$doctor->id}}/edit" class="text-blue-500 hover:text-blue-700 mr-2">
